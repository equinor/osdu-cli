...
:lint_func
echo linting
pylint osducli --msg-template="{path}({line}): [{msg_id}{obj}] {msg}" --load-plugins=scripts.license_verify_pylint
pylint scripts/license_verify_pylint.py --msg-template="{path}({line}): [{msg_id}{obj}] {msg}" --load-plugins=scripts.license_verify_pylint
pylint scripts/license_verify.py --msg-template="{path}({line}): [{msg_id}{obj}] {msg}" --load-plugins=scripts.license_verify_pylint
